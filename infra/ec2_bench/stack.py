    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        for idx in range(3):
            ...
            user_data.add_commands(
                ...
                f"aws s3 sync benchmarks/output_storage s3://{bucket_name}/{prefix_value}/$INSTANCE_TYPE/ --exclude \"*/single_table_total_*\" --exclude \"*/social_media_total_*\" --exclude \"*/bbc_news_*\" || true\n"
                f"aws s3 sync benchmarks/output_cold_start s3://{bucket_name}/{prefix_value}/cold_start/$INSTANCE_TYPE/ --exclude \"*/fixtures/*\" --exclude \"*/databases/*\" || true\n"
