    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        for idx in range(3):
            ...
            user_data.add_commands(
                ...
                "sync_once() {\n"
                "  aws s3 sync benchmarks/output_storage \"$SYNC_STORAGE\" --exclude \"*/single_table_total_*\" --exclude \"*/social_media_total_*\" --exclude \"*/bbc_news_*\" || true\n"
                "  aws s3 sync benchmarks/output_cold_start \"$SYNC_COLD\" --exclude \"*/fixtures/*\" --exclude \"*/databases/*\" || true\n"
                "}\n"
                "sync_once\n"
