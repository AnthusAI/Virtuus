#!/usr/bin/env python3
"""
Download cold-start benchmark artifacts from S3 into a local folder.

Example:
  python tools/pull_cold_results_s3.py \
    --bucket my-bucket \
    --prefix virtuus-bench/cold_start/ \
    --dest benchmarks/output_cold_start/ec2-sync
"""
...
def main() -> None:
    ...
    parser.add_argument("--dest", default="benchmarks/output_cold_start/ec2-sync")
